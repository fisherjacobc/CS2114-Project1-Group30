...
public class SortTest extends student.TestCase {
    ...
    public void testSortByMostRecent() {
        ArrayList<Review> result =
            Sort.sortByMostRecent(reviews, false);
    ...
    public void testSortByLeastRecent() {
        ArrayList<Review> result =
            Sort.sortByMostRecent(reviews, true);
    ...
    public void testSortAlphabetically() {
        ArrayList<Review> result =
            Sort.sortAlphabetically(reviews, false);
    ...
    public void testSortAlphabeticallyReversed() {
        ArrayList<Review> result =
            Sort.sortAlphabetically(reviews, true);
    ...
    public void testSortByRating() {
        ArrayList<Review> result =
            Sort.sortByRating(reviews, false);
    ...
    public void testSortByRatingReversed() {
        ArrayList<Review> result =
            Sort.sortByRating(reviews, true);
